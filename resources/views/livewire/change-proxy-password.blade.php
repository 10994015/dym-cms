<div class="app" id="changeMemberPassword">
    ...
    <div class="main-content">
        ...
        <table class="table table-striped table-bordered">
            <form action="/chk_change_proxy_password" method="post">
                @csrf
                <tbody>
                <tr>
                    <th>帳號</th>
                    <td><input type="text" name="username" class="form-control" disabled wire:model="username" /><input type="hidden" value="{{$proxy_id}}" name="proxy_id" /></td>
                </tr>
                <tr>
                    <th>會員密碼</th>
