...
window.addEventListener('searchUsersFn', function (e) {
  ...
  for (var _i12 = 0; _i12 < accountBtn.length; _i12++) {
    accountBtn[_i12].addEventListener('click', viewDownline);
  }
  for (var _i13 = 0; _i13 < document.getElementsByClassName('closeStatusBtn').length; _i13++) {
    closeStatusBtn[_i13].addEventListener('click', closeStatusFn);
  }
  for (var _i14 = 0; _i14 < document.getElementsByClassName('openStatusBtn').length; _i14++) {
    openStatusBtn[_i14].addEventListener('click', openStatusFn);
  }
});
/******/ })()
;